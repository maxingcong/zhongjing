                        ...
                        <div class="duel-details-list-body">
                            <div class="duel-match">
                                <div class="duel-match-logo" style="display: flex;align-items: center ;">
                                    <span style="display: inline-block;width: 200px;align-items: right">{{item.aName}}</span>
                                    <img style="border-radius: 50%;margin-left: 20px" CLASS="img-72"
                                         :src="item.aIcon"></div>
                            ...
                            <div class="duel-match" style="margin-left: -10px">
                                <div class="duel-match-logo" style="display: flex;align-items: center ;">
                                    <img
                                            class="img-72" style="border-radius: 50%;margin-right: 20px"
                                            :src="item.bIcon">
