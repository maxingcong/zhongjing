...
module.exports = {
  ...
  rules: {
    ...
    'eqeqeq': 0,//['error', 'smart'], //比较的时候使用严格等于
    ...
    // 'no-warning-comments': [1, {'terms': ['t odo', 'f ixme', 'any other term']}], //不允许警告备注
    'no-warning-comments': [1, {'terms': ['fixme', 'any other term']}], //不允许警告备注
    ...
    'quotes': 0,//[1, 'single', 'avoid-escape'], //引号风格
    'semi': 0,//[2, 'always'], //强制语句分号结尾
